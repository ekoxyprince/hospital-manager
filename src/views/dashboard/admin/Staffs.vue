...
import { StaffData } from "../../../constants/data/tabledata.js";
import StaffTable from "../../../components/ui/tables/StaffTable.vue";
...
<template>
  <StaffModal v-model="visible" @onclick="handleClick" />
